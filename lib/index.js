 ...
 * Created at Thu Oct 17 2019 19:05:12 GMT+0800 (GMT+08:00)
 */
'use strict';
...
function highlight(code, lang) {
  ...
  return "<pre class=\"language".concat(lang ? ' language-' + lang : '', "\" data-lang=\"").concat(lang, "\"><code v-html=\"'").concat(html, "'\"></code></pre>");
}
